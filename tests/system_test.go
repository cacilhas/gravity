...
func TestSystem_startWithBodies_GetBody(t *testing.T) {
...
func TestGravitySystem_sameNameBodies(t *testing.T) {
...
func TestSystem_GetBodies_AddBody(t *testing.T) {
...
func TestSystem_RemoveBody(t *testing.T) {
	body1, _ := gravity.NewBody("Assemble 1", 10, 0, 0, 0)
	body2, _ := gravity.NewBody("Assemble 2", 5, 0, 0, 0)
