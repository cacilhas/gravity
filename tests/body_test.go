...
func TestGravityBody_NullMass(t *testing.T) {
...
func TestGravityBody_NegativeMass(t *testing.T) {
...
func TestGravityBody_Get(t *testing.T) {
...
func TestGravityBody_SetPosition(t *testing.T) {
	body, _ := gravity.NewBody("Sample", 1, 3, 4, 0)
